...
const zhCN = {
  ...
  "settings.bookkeeping_habits": "记账习惯",
  "settings.bookkeeping_habits.help": "保存后会加入对话的系统提示词，并应用于当前账本的所有模型。",
  "settings.bookkeeping_habits.placeholder": "例如：餐饮统一记到 Expenses:Food；信用卡退款冲减原支出账户；收款方使用中文名称。",
...
const en: Record<I18nKey, string> = {
  ...
  "settings.bookkeeping_habits": "Bookkeeping habits",
  "settings.bookkeeping_habits.help": "Added to the system prompt after saving and applied to every model for this ledger.",
  "settings.bookkeeping_habits.placeholder": "For example: use Expenses:Food for dining; refunds reduce the original expense account; use Chinese payee names.",
